...
from ..structure.parse_gpcr_structures import fetch_uniprot_sequence
...
# Global settings
MODEL_PATH = "models/gpcr_activity_model"
DR_COORD_PATH = "data/processed/final_gpcr_dr_features.pt"
...
def generate_dr1286(uniprot_id, dr_coord_dict):
    ...
    # Load DR sets
    dr_sets = pd.read_csv(f"results/gpcr_dr_sets_thr_{DISP_THRESHOLD_AGO}_{DISP_THRESHOLD_ANT}_{DISP_THRESHOLD_STATE}.csv")
...
if __name__ == "__main__":
    ...
    input_csv = "data/sample/prediction_input.csv"  # Expected columns: UniProt_ID, Ikey, SMILES
